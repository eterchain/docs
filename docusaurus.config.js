...
const config = {
  ...
  organizationName: 'eterchain', // Usually your GitHub org/user name.
  projectName: 'eterchain', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Eterchain, Inc. Built with Docusaurus.`,
      },
      prism: {
